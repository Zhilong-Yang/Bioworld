namespace Bioworld.HTTP
{
    ...
    public static class Extensions
    {
            ...
            Action<IHttpClientBuilder> httpClientBuilder = null)
        {
            ...
            var clientBuilder = builder.Services.AddHttpClient<IHttpClient, BioworldHttpClient>(clientName);
            httpClientBuilder?.Invoke(clientBuilder);

            if (options.RequestMasking?.Enabled == true)
            {
                builder.Services.Replace(ServiceDescriptor
                    .Singleton<IHttpMessageHandlerBuilderFilter, BioworldHttpLoggingFilter>());
            }
        ...
        public static void RemoveHttpClient(this IBioWorldBuilder builder)
        {
