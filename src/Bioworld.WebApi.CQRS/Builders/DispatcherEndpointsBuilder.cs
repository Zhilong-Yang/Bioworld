namespace Bioworld.WebApi.CQRS.Builders
{
    using System;
    using System.Threading.Tasks;
    using Bioworld.CQRS.Commands;
    using Bioworld.CQRS.Queries;
    ...
    public class DispatcherEndpointsBuilder : IDispatcherEndpointsBuilder
    {
        ...
        public IDispatcherEndpointsBuilder Get(string path,
        ...
        public IDispatcherEndpointsBuilder Delete<T>(string path,
