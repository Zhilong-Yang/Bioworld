...
namespace Bioworld.MessageBrokers.RawRabbit.Registers
{
    using System;
    ...
    internal sealed class RabbitMqPluginRegister : IRabbitMqPluginRegister
    {
        ...
        private readonly List<(Action<IClientBuilder> buildClient,
            Action<IDependencyRegister> registerDependencies)> _plugins =
