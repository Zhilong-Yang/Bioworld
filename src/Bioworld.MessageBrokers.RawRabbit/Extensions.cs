...
using Bioworld.MessageBrokers.RawRabbit.Builders;
using Bioworld.MessageBrokers.RawRabbit.Processors;
using Bioworld.MessageBrokers.RawRabbit.Publishers;
using Bioworld.MessageBrokers.RawRabbit.Registers;
using Bioworld.MessageBrokers.RawRabbit.Subscribers;
using Bioworld.Persistence.Redis;
...
namespace Bioworld.MessageBrokers.RawRabbit
{
    public static class Extensions
    {
        ...
        private static void ConfigureBus<TContext>(IBioWorldBuilder builder,
            Func<IRabbitMqPluginRegister, IRabbitMqPluginRegister> plugins = null)
            where TContext : class, new()
        {
