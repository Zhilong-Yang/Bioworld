namespace Bioworld.MessageBrokers.Outbox.EntityFramework.Internals
{
    using System;
    using System.Collections.Generic;
    using System.Linq;
    using System.Threading.Tasks;
    using Bioworld.MessageBrokers.Outbox.Messages;
        ...
        public async Task<IReadOnlyList<OutboxMessage>> GetUnsentAsync()
        {
            ...
            return outboxMessages.Select(om =>
            {
                ...
                if (om.MessageType is {})
                {
                    ...
                    om.Message =
                        JsonConvert.DeserializeObject(om.SerializedMessageContext, messageType, SerializerSettings);
                }
